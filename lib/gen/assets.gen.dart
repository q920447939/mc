...
class $AssetsVideoGen {
  ...
  /// File path: assets/video/big_buck_bunny_720p_1mb.mp4
  String get bigBuckBunny720p1mb => 'assets/video/big_buck_bunny_720p_1mb.mp4';

  /// List of all assets
  List<String> get values => [bigBuckBunny720p1mb];
}
